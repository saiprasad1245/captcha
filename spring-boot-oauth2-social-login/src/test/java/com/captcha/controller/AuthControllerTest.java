...
import com.captcha.config.WithMockCustomUser;
...
class AuthControllerTest {
	...
	public void testRegisterUser() throws Exception {
		SignUpRequest signUpRequest = new SignUpRequest("1234", "captcha", user.getEmail(), user.getPassword(), user.getPassword(), SocialProvider.FACEBOOK,1,1);

...
import com.captcha.exception.OAuth2AuthenticationProcessingException;
...
import com.captcha.security.oauth2.user.OAuth2UserInfo;
import com.captcha.security.oauth2.user.OAuth2UserInfoFactory;
...
//		userRepository.flush();
	...
	private User buildUser(final SignUpRequest formDTO) {
		User user = new User();
		user.setDisplayName(formDTO.getDisplayName().trim());
		user.setEmail(formDTO.getEmail().trim());
		user.setPassword(passwordEncoder.encode(formDTO.getPassword().trim()));
